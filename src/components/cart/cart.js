                ...
                <div className="container-fluid mt-20 min-h-[100vh]">
                    <div className="row">
                        ...
                        <div className="card flex justify-center items-center flex-wrap space-y-4">
                            ...
                            <img src="https://i.imgur.com/NxmwdzX.png" width={130} height={130} className="img-fluid mx-auto" alt='cart' />
                            <h3 className="text-xl font-semibold mb-2 py-4"><strong>Your Cart is Empty</strong></h3>
                            <h4 className='py-4'>Add something to make me happy :)</h4>
                            <Link to={'/'} className="mt-8 rounded-md bg-red-500 py-2 px-4 font-medium text-blue-50 hover:bg-blue-600" data-abc="true">Continue Shopping</Link>
                        </div>
                    ...
                    <div className='mx-auto max-w-5xl justify-between px-6 md:flex md:space-x-6 xl:px-0 mt-10 min-h-[100vh]'>
                                ...
                                <div className="flex justify-between mb-6 rounded-lg border bg-white p-4 shadow-md sm:justify-start w-full" key={item.code}>
                                    ...
                                    <div className="flex flex-row w-full justify-between flex-wrap md:flex-nowrap">
                                        ...
                                        <div className="flex flex-col justify-normal space-y-6 items-center  w-[200px] ">
                                            ...
                                            <div>
                                                <GrClose size={22} className='ms-4 cursor-pointer dark:text-black' onClick={() => dispatch(deletFromCart(item))} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {cartState.cart.length > 0 && (
                            <div className="block h-full rounded-lg border bg-white p-6 shadow-md text-gray-700 md:w-1/3 mx-auto">
                                ...
                                <button className="mt-6 w-full rounded-md bg-indigo-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">Check out</button>
                            </div>
                        )}
