...
const InsertData = () => {
    ...
    return (
        <form className="container mx-auto w-full max-w-sm">
            <div className="md:flex md:justify-center mb-6">
                ...
                <div className="md:w-2/3">
                    <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-code" type="number" defaultValue="Enter the item code" ref={code} />
                </div>
            </div>
            ...
            <div className="md:flex md:items-center">
                <div className="md:w-1/3" />
                <div className="md:w-2/3">
                    <button className="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit" disabled={!isLoggedIn} onClick={handleSubmit}>
                        Submit
                    </button>
                </div>
            </div>
