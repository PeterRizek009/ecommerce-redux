    ...
    return (
        ...
        <div className="flex flex-wrap items-center">
            <section className="relative mx-auto">
                {/* navbar */}
                <nav className="flex justify-between bg-gray-900 text-white w-screen shadow-md">
                    <div className="px-5 xl:px-12 py-4 flex w-full items-center">
                        ...
                        <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                            ...
                            <li><Link className="hover:text-gray-200" to={"/Inser"}>Insert new Data</Link >
                            </li>
        ...
        //    <div className="flex items-center justify-between flex-wrap p-6 border-b-2 border-[#ee8441]  drop-shadow-md mb-5">
        ...
        //             </svg>
        //             <span className="ml-3 text-xl text-[#5b2a86]">E-commerce by Redux</span>
        //         </a>
        //         <nav className="relative flex flex-wrap items-center text-base justify-end text-white">
        //             <Link className="bg-red-500 mx-2 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg" to={"/insert"}>Insert</Link>
